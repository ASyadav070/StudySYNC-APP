        ...
        <div className="relative group">
          ...
          <div className="relative bg-white/[0.03] backdrop-blur-2xl rounded-2xl p-8 border border-white/10 shadow-2xl">
            ...
            >
              ...
              <p className="text-gray-300/60 text-sm">Join StudySync to start studying smarter</p>
            </motion.div>
            ...
            >
              <p className="text-sm text-gray-400">
                ...
                <Link to="/login" className="text-gray-200 hover:text-white font-medium hover:underline transition-colors">
                  Log in
                </Link>
              </p>
            </motion.div>
